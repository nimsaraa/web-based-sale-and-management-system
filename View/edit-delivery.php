...
$orderObj = new Order();
$delobj = new Delivery();
$delivery_id = base64_decode($_GET["delivery_id"]);
$orderResult = $orderObj->getAllorders();
$vehicleResult = $delobj->getAllVehicles();
$delResult = $delobj->getDelivery($delivery_id);
...
<div class="container">
    ...
    <div style="height: 50px" align="center">
        <div class="col-md-12">
            ...
            <form action="../Controller/delivery_controller.php?status=edit_delivery" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                            ...
                            <select name="order" id="order" class="form-control" required>
                                ...
                                while ($orderRow = $orderResult->fetch_assoc()) { ?>
                                    ...
                                    <option value="<?php echo $orderRow["order_id"]; ?>"
                                        ...
                                        <?php 
                                        if ($orderRow["order_id"] == $delRow["order_id"]) echo "selected";
                                        ?>
                                            >
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="payment_type" id="payment_type" value="<?php echo $delRow["payment_type"] ?>" readonly />
                            <input type="hidden" name="pay_type_id" id="pay_type_id_hidden" value="<?php echo $delRow["pay_type_id"] ?>" />
                        </div>
                    </div>
                            ...
                            <select name="vehicle" id="vehicle" class="form-control" required>
                                ...
                                while ($vehiclerow = $vehicleResult->fetch_assoc()) { ?>
                                    <option value="<?php echo $vehiclerow["vehicle_id"]; ?>"
                                        <?php 
                                        if ($vehiclerow["vehicle_id"] == $delRow["vehicle_id"]){
                                            ?>
...
<script>
    ...
    // Trigger change on page load to set initial payment fields
