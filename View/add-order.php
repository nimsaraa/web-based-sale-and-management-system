        ...
        <div class="container">
            ...
            <div style="height: 50px" align="center">
                <div class="col-md-12">
                    ...
                    <form action="../Controller/order_controller.php?status=add_order" method="post">
                        <div class="col-md-12">
                        <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-4">
                                <input type="date" class="form-control" name="ordate" id="ordate"  min="<?php echo date("Y-m-d") ?>"/>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover" id="productItemsTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="unit_price[]" step="0.01" oninput="calculateTotal(this)" >
                                                </td>

                                                <td>
                                                    <input type="text" class="form-control" name="quantity[]" oninput="calculateTotal(this)" >
                                                </td>
