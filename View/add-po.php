    ...
    <body>
        <div class="container">
            ...
            <div style="height: 50px" align="center">
                ...
                <form action="../Controller/purchase_controller.php?status=add_po" method="post" >
                    <div class="col-md-12">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="date" class="form-control" name="podate" id="podate" min="<?php echo date("Y-m-d") ?>"/>
                            </div>
                            <div class="col-md-2">
                                <label class="control-label">Po Total Amount (RS)</label>
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="po_total" id="po_total"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <tr>
                                                <td>
                                                    <select name="raw_id[]" id="raw_id" class="form-control" required="required">
                                                        <option value="">---------</option>
                                                        <?php
                                                        while ($rawRow = $stockResult->fetch_assoc()) {
                                                            ?>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="unit_price[]" step="0.01" oninput="calculateTotal(this)"  required>
                                                </td>

                                                <td>
                                                    <input type="text" class="form-control" name="quantity[]" oninput="calculateTotal(this)" required>
                                                </td>
                                                <td>
